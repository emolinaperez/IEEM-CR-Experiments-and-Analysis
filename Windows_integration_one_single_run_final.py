...
#build dictionaries
#df_exp_design = {'run_id': [1], 'data': ['d1'], 'sim' : ['s1']} # I need to parametrize this to all_runs
df_exp_design = {'run_id': [all_runs], 'data': ["".join(["d",str(all_runs)])], 'sim' : ["".join(["s",str(all_runs)])]}
